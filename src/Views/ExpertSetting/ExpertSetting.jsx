...
class ExpertSetting extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
            ...
            <div className="row">
              ...
              <div className="col-12 col-lg-7">
                ...
                <div className="user_account_card user_edit_pro_card">
                  <Link to="/expert-list" className="d-flex justify-content-between align-items-center">
                    <div>
                      <h3 className="f20 f600 clr_black mb-2">Expertise Listings</h3>
                ...
                <div className="user_account_card user_edit_pro_card">
                  <Link to="/hourly-rate" className="d-flex justify-content-between align-items-center">
                    <div>
                      <h3 className="f20 f600 clr_black mb-2">Hourly Rate</h3>
                ...
                <div className="user_account_card user_edit_pro_card">
                  <Link to="/availability" className="d-flex justify-content-between align-items-center">
                    <div>
                      <h3 className="f20 f600 clr_black mb-2">Availability</h3>
                      <p className="f14 f400 clr_grey">Credit Card, Debit card, Stripe, billing address Details</p>
                    </div>
                    <div>
                      <i className="fa fa-chevron-right clr_grey"></i>
