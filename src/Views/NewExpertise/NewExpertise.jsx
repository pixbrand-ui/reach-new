...
class NewExpertise extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 col-lg-7">
                        ...
                        <div className="col-12 my-3">
                            <div className="d-flex justify-content-end align-items-center">
                                ...
                                <Link to="/new-expertise-img" className="theme_dark_btn coupon_apply_btn cmn_btn">Continue</Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-lg-4">
                        <div className="choose_cover_img">
                            <label for="cover_img" className="cursor_pointer clr_white f16 f400">
                                <input type="file" id="cover_img" />
                                <img src={Images.add_big_icon.default} alt="" />Choose a cover image
                            </label>
                        </div>
                    </div>
