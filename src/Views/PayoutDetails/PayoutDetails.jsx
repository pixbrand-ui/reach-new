          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 col-lg-4">
                <div className="payout_card text-center">
                  <p className="f20 f700 clr_white mb-3">Total Payments Made</p>
                  <h2 className="f30 f500 clr_white mb-3 d-flex justify-content-center">$<span className="f60 f600 clr_green ms-2">120</span></h2>
                  <p className="f16 f400 clr_white">As of March 2021</p>
                </div>
              </div>
