                ...
                <div className="container">
                  <div className="row">
                    ...
                    <div className="col-12 col-lg-6">
                      ...
                      <div className="user_account_card">
                        <Link to="/expert-setting" className="d-flex justify-content-between align-items-center">
                          <div>
                            <h3 className="f20 f600 clr_black mb-2">Expert Settings</h3>
                            <p className="f14 f400 clr_grey">Basic Information, Topics, Photo, Become an expert.</p>
                          </div>
                          <div>
                            <i className="fa fa-chevron-right clr_grey"></i>
                    ...
                    <div className="col-12 col-lg-5 position_relative">
                    
                      <h2 className="f20 f500 clr_grey stats_head">Stats — Last 30 Days</h2>
