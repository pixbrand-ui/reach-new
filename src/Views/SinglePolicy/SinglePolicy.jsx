...
class SinglePolicy extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        ...
        <section id="single_policy_sec" className="single_policy_sec">
            <div className="container">
                ...
                <div className="row align-items-center m_b_150">
                    <div className="col-12 col-md-3">
                      <img src={Images.policy_img_2.default} alt="" className="w-100" />
                    </div>
                    <div className="col-md-1 d-md-block d-none"></div>
                    <div className="col-12 col-md-6">
                        <h2 className="f32 f600 clr_black mb-4">Privacy Policy</h2>
                        <p className="f16 f400 clr_black">
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-8">
                        ...
                        <div className="policy_cmn_brdr pb-3 mb-3" id="how_site">
