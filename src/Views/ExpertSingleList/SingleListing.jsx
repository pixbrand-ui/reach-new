      ...
      relatedExpertGrid: [
        {
          ...
          amount: '$20',
          detail: 'Start-up Equity: I can help you determine exactly how much equity each person in your start up deserves. Inventor of the...'
        },
        {
  ...
  render() {
    ...
    return (
      <React.Fragment>
                        ...
                        <div className="wrapper_for_pos_sicky">
                            <div className="expert_figures text-center single_list_figure mb-2">
                                <div>
                                    ...
                                    <Link to="" className="cmn_outline_grey_btn mb-2 w-100 f16 f600 clr_grey">Send a message</Link>
        ...
        <section className='related_topics_grid'>
          <div className="container">
              <div className="row related_experts_row">
                <h2 className="f24 f600 clr_black mb-4">Related experts</h2>

                {
                  this.state.relatedExpertGrid.map( (obj , key)=> {
                    return(
                      <div className="col-12 col-md-6 col-lg-4">
                        <div className="related_experts_card expert_cmn_card">
                          <div className="d-flex justify-content-between align-items-center mb-3">
                              ...
                              <div className='text-center'>
                                  <h6 className="f28 f600 clr_black">{obj.amount}</h6>
                                  <p className="f15 f400 clr_black">per hour</p>
                              </div>
                          </div>
                          <div>
                              <h5 className="f20 f600 clr_black mb-2">{obj.name}</h5>
                              <p className="f15 f400 clr_grey mb-2"><img src={Images.location.default} alt="" /> San Francisco, CA</p>
                              <p className="f15 f400 clr_grey mb-3">
                                {obj.location}
                              </p>
                              
                              <div className="mb-4 related_expert_btns">
                                  <Link to='' className="cmn_light_green_btn">Mobile applications</Link>
                                  <Link to='' className="cmn_light_green_btn">Mobile applications</Link>
                                  <Link to='' className="cmn_light_green_btn">+3</Link>
                              </div>

                              <div className="rel_expert_big_btn">
                                  <Link to='' className="theme_dark_btn ms-0 f16 f600">Request A Call</Link>
                                  <Link to='' className="cmn_outline_grey_btn me-0 f16 f600 clr_grey">Message</Link>
                              </div>
                          </div>
                        </div>
                      </div>
