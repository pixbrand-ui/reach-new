  ...
  render() {
    ...
    return (
      <React.Fragment>
                      ...
                      <ul>
                          ...
                          <div className="d-block d-lg-none">
                            <ul className="categories_links">
                                <li><Link className="dropdown-item" to="category_listing_page.php">Entrepreneurship</Link></li>

                                <li><Link className="dropdown-item" to="category_listing_page.php">Digital marketing</Link></li>

                                <li><Link className="dropdown-item" to="category_listing_page.php">Start-ups</Link></li>

                                <li><Link className="dropdown-item" to="category_listing_page.php">SMM</Link></li>

                                <li><Link className="dropdown-item" to="category_listing_page.php">Technology</Link></li>

                                <li><Link className="dropdown-item" to="category_listing_page.php">Other menu</Link></li>
        ...
        <LoginModal open={(this.state.loginModal) ? true : false} toggle={() => this.closeModal('loginModal')}  className={'loginModal'}>
              <div className="row m-0 b_radius_8">
                <div className="col-sm-6 bg_dark_green modal_left_side" style={{backgroundImage: `url(${Images.modal_side_img.default})`}}>
                    <div className="modal_padding login_modal_content h-100">
                         {/* <h2 className="f28 f500 clr_white">
                            <span className="clr_green">Welcome!</span> find your best
        ...
        {/* User Review modal */}
        <CommonNotifyModal open={(this.state.userReviewModal) ? true : false} toggle={()=> this.closeModal('userReviewModal')} className={'userReviewModal'}>
                            ...
                            return(
                              <div className="col-12 mb-2" key={key}>
                                <div className={`custom_checkiee deactivate_check_wrapper ${obj.check ? 'active' : ''}`}>
                                  ...
                                  <label htmlFor={`check_${key}`} className="f16 f400 clr_black" onClick={()=> this.togglereview(key , 'userReviews')}>{obj.title}</label>
                                </div>
                              </div>
                            )
                          })
